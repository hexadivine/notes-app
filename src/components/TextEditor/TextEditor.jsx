...
function TextEditor() {
    return <div className="w-[80%] h-screen bg-light-blue">
        <input type="text" className="w-full py-10 bg-light-blue font-bold text-[30px] px-5 focus:outline-none font-['Poppins']" style={{forntFamily: 'poppins'}} placeholder="Title"/>
